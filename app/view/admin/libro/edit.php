    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            function category($cat,$dat=[]){
                ...
                <form action="../../LibroController/edit/<?php echo $datos['id'];?>" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php foreach ($datos['categorias'] as $categoria):?>
                                            <?php if($categoria->id==$datos['categoria']){
                                                  echo "<option value=".$datos['categoria']." selected='selected'>". $categoria->nombre."</option>";
                                                }else{
                                                    echo "<option value=".$datos['categoria'].">". $categoria->nombre."</option>";
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="descripcion" id="descripcion"
                                            rows="8"><?php echo $datos['descripcion'];?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" id="stock" name="stock" 
                                            value="<?php echo $datos['stock'];?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" name="imagen" id="imagen" multiple
                                            accept="image/*" value="<?php echo $datos['titulo'];?>">
